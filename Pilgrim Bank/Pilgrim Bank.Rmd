...
# Clustering
Ora, dal dataset senza outliers, consideriamo solo coloro che nel 1999 erano offline (`Online9=0`) e che sono rimasti clienti nel 2000 (`Retain=1`)
...
Se c'è NA tutti gli Age e Income sono 0 ad indicare un'altra classe!!! Tenure>=40 è quando sono tutti 0 
