...
```{r AgeAverage}
mm = mean(Age, na.rm=TRUE) #nel calcolo della media non consideriamo i valori mancanti
...
data_balanced_under <- ovun.sample(as.factor(Retain) ~ Profit9+Online9+AgeZero+AgeGiven
                                    +IncomeZero+IncomeGiven+Tenure+District1100
                                    +District1200, method = "under",N = 10476)$data
set.seed(1)
